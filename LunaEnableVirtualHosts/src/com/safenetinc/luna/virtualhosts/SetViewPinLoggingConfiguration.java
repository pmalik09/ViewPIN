...
/**
 * Class to work as an SP command for adding and changing the logging configuration of a ViewPin instance
 * running within a tomcat virtual host.
 * 
 * @author Paul Hampton
 * 
 */
public class SetViewPinLoggingConfiguration
{
    ...
    private static final String AGENT_CONFIGURATION_FILE_NAME        = "pinagent-log4j.xml";
    ...
    public void setConfiguration (String virtualHostName)
    {
        ...
        System.out.println("Logging configuration successfully added to virtual host " + lowerCaseVirtualHostName);
    }
    ...
    public static void main (String[] args)
    {
        ...
        OptionBuilder.withDescription("The name of the virtual host to import logging configuration for");
        ...
        SetViewPinLoggingConfiguration configure = new SetViewPinLoggingConfiguration();
