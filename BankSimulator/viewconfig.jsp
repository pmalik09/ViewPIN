...
<%@page import="com.safenetinc.viewpin.banksimulator.config.BankSimulatorUser"%>
...
<head>
	<title>SafeNet ViewPIN Demonstration System - User List</title>
		  ...
		  <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td align="left" valign="top" bgcolor="#CCCCCC"><p>&nbsp;</p>
                <p class="style1">Current Users:</p>
