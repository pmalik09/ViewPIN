// $Id: BankSimulator/externalsource/com/safenetinc/viewpin/simulator/authority/PinRetrievalResponseGenerator.java 1.1 2008/09/04 10:38:30IST Mkhurana Exp  $
...
import com.safenetinc.viewpin.simulator.authority.xml.encryption.XmlEncryptionAlgorithmMapper;
...
public class PinRetrievalResponseGenerator
{
     ...
     */
    public PinRetrievalResponse generatePinRetrievalResponse (Document pinRetrievalRequestDocument, SecretKey sessionKey, String encryptionMethodAlgorithm, CardAccount cardAccount,
            String signatureMethodAlgorithm, String digestMethodAlgorithm, SecureRandom randomNumberGenerator) throws PinRetrievalRequestException, PinRetrievalResponseException
    {
        ...
        catch (Exception e)
        {
            ...
            throw new PinRetrievalRequestException("retrieving timestamp");
        }
        ...
        catch (Exception e)
        {
            ...
            throw new PinRetrievalRequestException("retrieving transaction identifier");
        }

        getLogger().debug("transaction identifier = " + transactionIdentifier);

        getLogger().debug("creating empty pin retrieval response document");
        ...
        catch (Exception e)
        {
            ...
            throw new PinRetrievalResponseException("instantiating document builder");
        }

        // Create empty pin retrieval response document
        pinRetrievalResponseDocument = db.newDocument();

        getLogger().debug("created empty pin retrieval response document");
        ...
        cardAccountPins = cardAccount.getPins();

        // Iterate through pin numbers
        while (cardAccountPins.hasNext() == true)
        {
            ...
            catch (Exception e)
            {
                ...
                throw new PinRetrievalResponseException("generating pin EncryptedData element");
            }
        ...
        catch (Exception e)
        {
            ...
            throw new PinRetrievalResponseException("creating enveloped signature element");
        }
        ...
        catch (Exception e)
        {
            ...
            throw new PinRetrievalResponseException("creating KeyInfo element");
        }
        ...
        catch (Exception e)
        {
            ...
            throw new PinRetrievalResponseException("compressing pin retrieval response document");
        }
            ...
            throws IllegalBlockSizeException, BadPaddingException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, InvalidAlgorithmParameterException
    {
        ...
        getLogger().debug("generating intialisation vector");
