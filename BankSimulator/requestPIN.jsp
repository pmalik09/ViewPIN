					...
					<tr>
					  ...
					  <form action="<%=xmlconfig.getString("RequestPostURL(0)")%>" ,="" method="post" onsubmit="return validate(this)">
						...
						<tr>
							...
							<input name="authorityname" type="hidden", value="<%=xmlconfig.getString("PinAuthorityName(0)")%>">
							<input name="requesttype" type="hidden", value=02><input name="submit" value="submit" type="submit">
					</form>
					</td>
					</tr>
					</tr>
