// $Id: KeyManagement/src/com/safenetinc/viewpin/utils/GenerateCertificateRequest.java 1.12 2013/09/25 09:43:13IST Malik, Pratibha (Pmalik) Exp  $
...
public class GenerateCertificateRequest
{
    ...
    private boolean generateCertificateRequest (int keyLength, X500Principal subject, int expireAfterDays)
    {
        ...
        try
        {
            ...
            selfSignedCertificate = certificateGenerator.generate(kp.getPrivate(), "LunaProvider");
            ...
            certificateRequest = new PKCS10CertificationRequest("SHA1withRSA", subject, kp.getPublic(), null, kp.getPrivate(), "LunaProvider");
