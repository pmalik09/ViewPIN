...
public class XmlEncryption
{
     ...
     * 
     * @param viewPinRequestDocument The document in question
     ...
     * @param rootElement the request element identifier
     ...
     * @throws XPathFactoryConfigurationException Thrown if there is a problem invoking the XPath engine
     */
    public static SecretKey recoverSessionKey (Document viewPinRequestDocument, String sessionCipherEncryptionMethodAlgorithm, KeyStore authorityKeyStore, String rootElement) throws KeyStoreException,
    NoSuchAlgorithmException, UnrecoverableKeyException, XPathExpressionException, NoSuchPaddingException, InvalidKeyException, XPathFactoryConfigurationException
	{
		...
		// Get pin authority wrapping certificate subject key identifier
			...
			encodedPinAuthorityWrappingCertificateSubjectKeyIdentifier = (String) xp.evaluate("/vp:"+rootElement+"/xenc:EncryptedKey/ds:KeyInfo/ds:X509Data/ds:X509SKI/text()",
					viewPinRequestDocument, XPathConstants.STRING);
		...
		// Get EncryptedKey element
			...
			encryptedKeyElement = (Element) xp.evaluate("/vp:"+rootElement+"/xenc:EncryptedKey[@Id = 'EK']", viewPinRequestDocument, XPathConstants.NODE);
		...
		// Get encoded wrapped session key
			...
			encodedWrappedSessionKey = (String) xp.evaluate("/vp:"+rootElement+"/xenc:EncryptedKey[@Id = 'EK']/xenc:CipherData/xenc:CipherValue/text()", viewPinRequestDocument,
