...
public class XmlSignature
{
     ...
     */
    public static boolean verifySignature (Document viewPinRequestDocument, KeyStore agentKeyStore, String rootElement) throws XPathExpressionException, KeyStoreException, InvalidKeyException,
            ...
            XPathFactoryConfigurationException
    {
        ...
        // Get viewPinRequest element
        viewPinRequestElement = (Element) xp.evaluate("/vp:"+ rootElement, viewPinRequestDocument, XPathConstants.NODE);
        
        // Get Signature element
        
        signatureElement = (Element) xp.evaluate("ds:Signature", viewPinRequestElement, XPathConstants.NODE);
        ...
        if (verifyEnvelopedSignatureReference(viewPinRequestDocument, rootElement) == false)
        {
    ...
    private static boolean verifyEnvelopedSignatureReference (Document viewPinRequestDocument, String rootElement) throws XPathExpressionException, InvalidCanonicalizerException, CanonicalizationException,
    NoSuchAlgorithmException, XPathFactoryConfigurationException
	{
		...
		// Get PinRetrievalRequest element
			 ...
			 pinRetrievalRequestElement = (Element) xp.evaluate("/vp:"+ rootElement, viewPinRequestDocument, XPathConstants.NODE);
		...
		// Get digest value
			...
			encodedDigestValue = (String) xp.evaluate("/vp:"+rootElement+"/ds:Signature/ds:SignedInfo/ds:Reference/ds:DigestValue/text()", viewPinRequestDocument, XPathConstants.STRING);
		
		
		// Get digest method algorithm
		
			digestMethodAlgorithm = (String) xp.evaluate("/vp:"+rootElement+"/ds:Signature/ds:SignedInfo/ds:Reference/ds:DigestMethod/@Algorithm", viewPinRequestDocument, XPathConstants.STRING);
