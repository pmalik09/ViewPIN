// $Id: PinAuthority/src/com/safenetinc/viewpin/authority/Utils.java 1.2 2013/09/25 09:46:04IST Malik, Pratibha (Pmalik) Exp  $
...
import com.safenetinc.viewpin.authority.xml.resources.FileSystemResourceResolver;
...
public class Utils
{
    ...
    {
    	//the commented section is to be used when LunaKeystore is not to be used
    	/*
        KeyStore ks;
        FileInputStream fis;
