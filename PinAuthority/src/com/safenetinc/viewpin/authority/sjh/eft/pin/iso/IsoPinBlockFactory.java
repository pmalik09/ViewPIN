...
import com.safenetinc.viewpin.authority.sjh.common.EntropyPool;
...
public class IsoPinBlockFactory 
{
	...
	//	SecretKey encryptionKey = (SecretKey)getZonePinKeyStore().getKey(zonePinKeyAlias, null); 
		SecretKey zonePinKey = (SecretKey)getZonePinKeyStore().getKey(zonePinKeyAlias, null); 
